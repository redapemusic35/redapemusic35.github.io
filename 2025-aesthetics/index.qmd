...
***Grading:*** Evaluated using the rubric with 4 categories (thesis, premises, support, student response), each scored 10–40 points (max 160). See rubrics.
...
***Grading:*** Evaluated using the rubric with 4 categories, each scored 6–24 points (max 96). See rubrics.
...
***Grading:*** Evaluated using the rubric with 4 categories, each scored 5–20 points (max 80). See rubrics.
